...
public class standardanagram{
	...
	public static int[] getCharCounts(String s){
		int[] charConts = new int[NUMBER_LETTERS];
	...
	public static int numberNeeded(String first,String second){
		int[] charCont1 = getCharCounts(first);
		int[] charCont2 = getCharCounts(second);
		return getDelta(charCont1,charCont2);
	}
